...
const getStaticProps = async context => {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://admin:JNbLkoH95HK6UXIF@cluster0.1q90f.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
